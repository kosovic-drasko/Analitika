...
class TabelaResourceIT {
    ...
    void checkRegionIsRequired() throws Exception {
        int databaseSizeBeforeTest = tabelaRepository.findAll().size();
        // set the field null
        tabela.setRegion(null);

        // Create the Tabela, which fails.
        ...
        List<Tabela> tabelaList = tabelaRepository.findAll();
        assertThat(tabelaList).hasSize(databaseSizeBeforeTest);
    }

    @Test
    @Transactional
    void checkPrometIsRequired() throws Exception {
        int databaseSizeBeforeTest = tabelaRepository.findAll().size();
        // set the field null
        tabela.setPromet(null);
