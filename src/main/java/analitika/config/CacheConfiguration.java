...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, analitika.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, analitika.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, analitika.domain.TabelaTest.class.getName());
