...
import analitika.repository.TabelaRepository;
...
/**
 * REST controller for managing {@link analitika.domain.Tabela}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TabelaResource {
    ...
    public ResponseEntity<Tabela> updateTabela(
        @PathVariable(value = "id", required = false) final Long id,
        @Valid @RequestBody Tabela tabela
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tabela.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tabela> partialUpdateTabela(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody Tabela tabela
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tabela.getId().toString())
        );
    }
